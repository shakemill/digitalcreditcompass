...
export default function ProfilePage() {
  ...
  return (
    <div className="w-full space-y-8">
      <div>
        <h2 className="font-heading text-2xl font-semibold text-text-primary">My profile</h2>
      ...
      <div className="grid w-full grid-cols-1 gap-6 lg:grid-cols-2 lg:items-stretch">
        <div className="flex flex-col rounded-xl border border-border bg-surface-card p-6 shadow-sm">
          ...
          <form onSubmit={handleUpdateProfile} className="mt-4 flex flex-1 flex-col space-y-4">
            <div>
        ...
        <div className="flex flex-col rounded-xl border border-border bg-surface-card p-6 shadow-sm">
          ...
          <form onSubmit={handleChangePassword} className="mt-4 flex flex-1 flex-col space-y-4">
            <div>
